...
![Формула Гауссова распределения](image.png)
...
![Зависимости между размером ядра и значением σ](all_kernels.png)
...
![Использование ядра 3х3 и σ 0.5](numpy_k3_s0.5_color.png)
![Использование ядра 7х7 и σ 1.5](numpy_k7_s1.5_color.png)
![Использование ядра 21х21 и σ 5.0](numpy_k21_s5.0_color.png)
